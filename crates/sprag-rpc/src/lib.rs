...
pub use client::{
    ...
    NO_EXTERNAL_FAULT, Outstanding, PANE_PARAM, PANE_REVISION_FIELD, PANE_WAIT_OUTPUT_METHOD,
    PANE_WAIT_REVISION_METHOD, PATTERN_PARAM, PROTOCOL_FIELD, PROTOCOL_PARAM, ROWS_PARAM, RpcFault,
