...
pub use client::{
    ...
    EVENTS_WAIT_METHOD, HOST_SILENT, HostConn, INVALID_PARAMS, MESSAGE_FIELD, NEEDLE_PARAM,
    PANE_PARAM, PANE_WAIT_OUTPUT_METHOD, PATTERN_PARAM, PROTOCOL_FIELD, PROTOCOL_PARAM, ROWS_PARAM,
    RpcFault, SESSION_PARAM, SINCE_PARAM, SUBSCRIPTION_PARAM, ScopeAsk, ScopeFault,
    UNKNOWN_ACTION_FAULT, UNKNOWN_SLOT_FAULT, UNSTATED_REFUSAL_FAULT, WINDOW_PARAM, WIRE_PROTOCOL,
