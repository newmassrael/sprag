...
pub use client::{
    ...
    CallError, EVENTS_WAIT_METHOD, HostConn, INVALID_PARAMS, NEEDLE_PARAM, PANE_PARAM,
    PANE_WAIT_OUTPUT_METHOD, PATTERN_PARAM, PROTOCOL_FIELD, PROTOCOL_PARAM, ROWS_PARAM, RpcFault,
    SESSION_PARAM, SINCE_PARAM, WIRE_PROTOCOL, gui_client_prefix, new_gui_client_id,
};
