...
pub mod endpoint;
pub use client::{
    ATTACHED_PARAM, CLIENT_ATTACH_METHOD, CLIENT_HELLO_METHOD, CLIENT_MESSAGES_METHOD, CLIENT_PARAM,
    CLIENT_SIZE_METHOD, COLS_PARAM, CallError, EVENTS_CHANGED_METHOD, EVENTS_SUBSCRIBE_METHOD,
    EVENTS_UNSUBSCRIBE_METHOD, EVENTS_WAIT_METHOD, HostConn, INVALID_PARAMS, MESSAGE_FIELD,
    NEEDLE_PARAM, PANE_PARAM, PANE_WAIT_OUTPUT_METHOD, PATTERN_PARAM, PROTOCOL_FIELD,
    PROTOCOL_PARAM, ROWS_PARAM,
